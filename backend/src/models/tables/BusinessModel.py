...
class BusinessModel(Base):
    ...
    BusinessModelId = Column(
        Integer, primary_key=True, nullable=False, autoincrement=True
    )
    ExistingSolutionId = Column(
        Integer, ForeignKey("ExistingSolution.ExistingSolutionId"), nullable=False
    )
    ...
    existing_solution = relationship(
        "ExistingSolution", back_populates="BusinessModels"
    )
