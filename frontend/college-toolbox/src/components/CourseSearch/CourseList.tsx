  ...
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table className="w-full text-sm text-left text-gray-500 dark:text-white">
        ...
        <tbody>
          {courses.map((course) => (
            <tr key={course.code} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <th scope="row" className="px-4 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                {course.code}
              </th>
              <td className="px-4 py-4 dark:text-white">{course.name}</td>
              <td className="px-4 py-4 dark:text-white">{course.section}</td>
              <td className="px-4 py-4 dark:text-white">{course.professor}</td>
              <td className="px-4 py-4 dark:text-white">{course.credits}</td>
              <td className="px-4 py-4 dark:text-white">{course.room}</td>
              <td className="px-4 py-4 dark:text-white">{course.days}</td>
              <td className="px-4 py-4 dark:text-white">{course.time}</td>
